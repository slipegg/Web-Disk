...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        Form.resize(1394, 457)
        self.tableWidget = QtWidgets.QTableWidget(Form)
        self.tableWidget.setGeometry(QtCore.QRect(0, 0, 1381, 451))
...
"")
    ...
    def retranslateUi(self, Form):
        ...
        item.setText(_translate("Form", "上传日期"))
        ...
        item.setText(_translate("Form", "复制"))
        item = self.tableWidget.horizontalHeaderItem(6)
        item.setText(_translate("Form", "剪切"))
        item = self.tableWidget.horizontalHeaderItem(7)
        item.setText(_translate("Form", "删除"))
        item = self.tableWidget.horizontalHeaderItem(8)
        item.setText(_translate("Form", "重命名"))
